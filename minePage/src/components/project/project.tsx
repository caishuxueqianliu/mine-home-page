                       ...
                       return ( <div key={index} >
                               ...
                               <div className="row featurette" style={{backgroundColor:'#f8f9fa'}}>
                                   ...
                                   <div className="col-md-8 order-md-1">
                                       <img style={{height:500}} className={'bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto'} src={`https://101.35.251.32:8002/assets/images/project/${productabbr}/${item}.png`} alt=""/>
                                   </div>
                               </div>
